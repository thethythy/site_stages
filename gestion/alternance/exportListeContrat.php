...
/**
 * Page exporterListeContrat.php
 * Utilisation : page pour exporter un contrat
 * Dépendance(s) : exportListeContratData.php --> traitement des requêtes Ajax
...
IHM_Generale::header("Exporter", "un contrat d'aternance", "../../", $tabLiens);
...
Promotion_IHM::afficherFormulaireRecherche("exportListeContratData.php", false);

// Affichage des données
echo "<div id='data'>\n";
include_once("exportListeContratData.php");
echo "\n</div>";
?>
<br/><br/>
