...
/**
 * Page modifierListeEntrepriseData.php
 * Utilisation : page de traitement Ajax retournant un tableau interactif des
 *		 entreprises filtrées et classées par orde alphabétique
