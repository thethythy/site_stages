...
for ($annee = 2009; $annee < 2016; $annee++) {
	$conventionM1 = recupererDonneeM1($annee);
	$conventionM2 = recupererDonneeM2($annee);
	echo "<div id='annee".$annee."'></br>";
	afficher($conventionM1, $conventionM2, $annee);
	echo "</div></br>";
}


function afficher($conventionM1, $conventionM2, $annee) {
