...
/**
 * Page mailAttributionReferentStageData.php
...
if (isset($_POST['annee']) && $_POST['annee'] > 0) {
    ...
    $tabOA = Attribution::getListeAttributionFromPromotion(
	    $_POST['annee'], $_POST['parcours'], $_POST['filiere']);

    Attribution_IHM::afficherSelectionDestinairesNotification(
	    $tabOA, $_POST['annee'], $_POST['parcours'], $_POST['filiere'],
	    'mailAttributionReferentStage.php');
