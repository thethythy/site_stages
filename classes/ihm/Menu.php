...
class Menu {
	...
	public static function menuPresentation() {
		?>
			<div id="sidebar">
				<li><a href="#1">1. Présentation</a></li>
				<li><a href="#11">1.1. Contenu du stage</a></li>
				<li><a href="#12">1.2. Planification et durée</a></li>
				<li><a href="#13">1.3. Remarques et conseils</a></li>
				<li><a href="#2">2. Déroulement du stage</a></li>
				<li><a href="#21">2.1. La recherche d'un stage</a></li>
				<li><a href="#22">2.2. Le suivi du stagiaire</a></li>
				<li><a href="#221">2.2.1. Rôle du référent</a></li>
				<li><a href="#222">2.2.2. Choix du référent</a></li>
				...
				<li><a href="#26">2.6. Résumé de la procédure</a></li>
				<li><a href="#3">3. La soutenance</a></li>
				<li><a href="#4">4. L'évaluation du stage</a></li>
				<br/>
			</div>
		  	<div id="main">
		<?php
