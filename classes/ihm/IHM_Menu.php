...
class IHM_Menu {
	...
	<div id="sidebar">
		...
		<br/>
		<li><a href="https://sciences.univ-lemans.fr/fr/ma-scolarite.html">3- Etablir la convention</a></li>
		<br/>
		...
		<ul class="sidemenu2">
		    ...
		    <li><a href="https://globalplacement.com" alt="stage, stages, volontaire, stagiaire, stagiaires" title="stages internationaux, internships, internship, stages et travaille volontaire internationaux" >GlobalPlacement</a></li>
		    <li><a href="http://www.iquesta.com/" alt="iquesta.com" title="iquesta.com">iquesta.com</a></li>
		    <li><a href="http://talent.com" alt="neuvoo.fr" title="neuvoo">talent.com</a></li>
		</ul>
	    </ul>
	</div>
	<div id="main">
