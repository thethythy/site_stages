...
class Promotion_IHM {
    ...
    /**
     * Afficher une liste des étudiants avec ou sans convention / contrat (tableau statique)
     * @param integer $annee L'année concernée
     * @param tableau d'objets $tabEtudiants Les étudiants concernés
     */
    public static function afficherListeConventionsContrats($annee, $tabEtudiants) {
	?>
	<table>
	    <tr id="entete">
	    ...
	    <tr id="entete2">
		<td></td>
		<td align="center"><?php echo $nbConventions; ?></td>
		<td align="center"><?php echo $nbContrats; ?></td>
	    </tr>
	    <tr id='entete'>
		<td colspan="3" align="center">
		    Total : <?php echo ($nbConventions+$nbContrats) . " / " . $nbEtudiants; ?>
		</td>
	    </tr>
	</table>
	<?php
