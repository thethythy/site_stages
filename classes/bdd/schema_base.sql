...
CREATE TABLE IF NOT EXISTS `stages`.`entreprise` (
  ...
  `siret` BIGINT(14) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `stages`.`contrat` (
  ...
  `typedecontrat` TINYINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `stages`.`candidature_alternance` (
  ...
  INDEX `fk_candidature_alternance_etudiant_idetudiant` (`idetudiant` ASC),
  INDEX `fk_candidature_alternance_offredalternance_idoffre` (`idoffre` ASC),
  INDEX `fk_candidature_alternance_entreprise_identreprise` (`identreprise` ASC),
...
-- -----------------------------------------------------
-- Table `stages`.`responsbale`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `stages`.`responsbale` (
  `idresponsbale` INT(10) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`idresponsbale`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `stages`.`relation_promotion_offredestage`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `stages`.`relation_promotion_offredestage` (
  `idpromotion` INT(10) NOT NULL,
  `idoffre` INT(10) NOT NULL,
  INDEX `fk_relation_p_o_offredestage_idoffre_idx` (`idoffre` ASC),
  INDEX `fk_relation_p_os_promotion_idpromotion_idx` (`idpromotion` ASC),
  CONSTRAINT `fk_relation_p_os_offredestage_idoffre`
    FOREIGN KEY (`idoffre`)
    REFERENCES `stages`.`offredestage` (`idoffre`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_relation_p_os_promotion_idpromotion`
    FOREIGN KEY (`idpromotion`)
    REFERENCES `stages`.`promotion` (`idpromotion`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `stages`.`relation_promotion_offredalternance`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `stages`.`relation_promotion_offredalternance` (
  `idpromotion` INT(10) NOT NULL,
  `idoffre` INT(10) NOT NULL,
  INDEX `fk_relation_p_oa_offredalternance_idoffre_idx` (`idoffre` ASC),
  INDEX `fk_relation_p_oa_promotion_idpromotion_idx` (`idpromotion` ASC),
  CONSTRAINT `fk_relation_p_oa_offredalternance_idoffre`
    FOREIGN KEY (`idoffre`)
    REFERENCES `stages`.`offredalternance` (`idoffre`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_relation_p_oa_promotion_idpromotion`
    FOREIGN KEY (`idpromotion`)
    REFERENCES `stages`.`promotion` (`idpromotion`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
