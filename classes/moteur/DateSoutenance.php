...
class DateSoutenance {
	...
	public static function getDateSoutenance($idDateSoutenance){
		...
		return new DateSoutenance($dateSoutenanceBDD["iddatesoutenance"], $dateSoutenanceBDD["jour"], $dateSoutenanceBDD["mois"], $dateSoutenanceBDD["annee"]);
	}
	
	public static function saisirDonneesDateSoutenance($tab_donnees){
		$dateSoutenance = new DateSoutenance('',$tab_donnees[0],$tab_donnees[1],$tab_donnees[2]);
	...
	public static function listerDateSoutenance($filtres=''){
		...
		for($i=0; $i<sizeof($tabDateSoutenanceString); $i++)
			array_push($tabDateSoutenance, new DateSoutenance($tabDateSoutenanceString[$i][0],$tabDateSoutenanceString[$i][1],$tabDateSoutenanceString[$i][2],$tabDateSoutenanceString[$i][3]));
