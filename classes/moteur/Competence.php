...
class Competence{
	...
	public static function getCompetence($identifiantCompetence) {
		...
		$competence = new Competence($competenceString['idcompetence'], $competenceString['nomcompetence']);
	...
	public static function listerCompetences() {
		...
		for($i=0; $i<sizeof($tabCompetenceString); $i++)
  			array_push($tabCompetences, new Competence($tabCompetenceString[$i][0],$tabCompetenceString[$i][1]));
