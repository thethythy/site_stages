...
class Tache {
    ...
    public static function getTache($idTache) {
        ...
        return new Tache($tacheBDD["idtache"], $tacheBDD["intitule"], $tacheBDD["statut"], $tacheBDD["priorite"], $tacheBDD["datelimite"]);
    }

    public static function saisirDonneesTache($tab_donnees) {
        $tache = new Tache('', $tab_donnees[0], $tab_donnees[1], $tab_donnees[2], $tab_donnees[3]);
    ...
    public static function listerTaches() {
        ...
        foreach (Tache_BDD::getTaches() as $sTache)
            array_push($tabOTache, new Tache($sTache[0], $sTache[1], $sTache[2], $sTache[3], $sTache[4]));
