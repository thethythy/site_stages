...
class Soutenance {
	...
	public function Soutenance($identifiantBDD, $identifiantDateSoutenance, $identifiantSalle, $heureDebut, $minuteDebut, $aHuitClos) {
	...
	public static function getSoutenance($idSoutenance){
		...
		return new Soutenance($soutenanceBDD["idsoutenance"], $soutenanceBDD["iddatesoutenance"], $soutenanceBDD["idsalle"], $soutenanceBDD["heuredebut"], $soutenanceBDD["mindebut"], $soutenanceBDD["ahuitclos"]);
	}
	
	public static function getConvention($soutenance) {
		$tab_donnees = Soutenance_BDD::getConvention($soutenance->getIdentifiantBDD());
		return new Convention($tab_donnees[0],$tab_donnees[1],$tab_donnees[2],$tab_donnees[3],$tab_donnees[4],$tab_donnees[5],$tab_donnees[6],$tab_donnees[7],$tab_donnees[8]);
	}
