...
class SujetDeStage {
  ...
  */
  ...
  $identifiantPromotion, $description, $valide, $enAttenteDeValidation) {
    ...
    // Utils::printLog($this->identifiantBDD." ".
    // $this->identifiantEtudiant." ".
    // $this->identifiantPromotion." ".
    // $this->description." ".
    // $this->valide." en attente de validation ".
    // $this->enAttenteDeValidation);
  }
  ...
  public function isEnAttenteDeValidation() {
      // Utils::printLog("Attente validation ".$this->enAttenteDeValidation);
