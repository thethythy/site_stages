...
class ThemeDeStage {
	...
	public static function getThemeDeStage($id){
		...
		return new ThemeDeStage($themeDeStageStr['idtheme'], $themeDeStageStr['theme'], $themeDeStageStr['idcouleur']);
	}
	...
	public static function getListeTheme(){
		...
		for($i=0; $i<sizeof($tabThemesStr); $i++)
  			array_push($tab_themes, new ThemeDeStage($tabThemesStr[$i][0], $tabThemesStr[$i][1], $tabThemesStr[$i][2]));
