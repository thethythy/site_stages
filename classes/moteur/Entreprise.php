...
class Entreprise {
    ...
    public function __construct($identifiantBDD, $nom, $adresse, $codePostal, $ville, $pays, $email, $idTypeEntreprise, $siret) {
	...
	return new Entreprise(
		$entrepriseBDD["identreprise"], $entrepriseBDD["nom"],
		$entrepriseBDD["adresse"], $entrepriseBDD["codepostal"],
		$entrepriseBDD["ville"], $entrepriseBDD["pays"],
		$entrepriseBDD["email"], $entrepriseBDD["idtypeentreprise"],
		$entrepriseBDD["siret"]);
    }
	...
	for ($i = 0; $i < sizeof($tabEntrepriseString); $i++)
	    array_push($tabEntreprise, new Entreprise(
		    $tabEntrepriseString[$i][0], $tabEntrepriseString[$i][1],
		    $tabEntrepriseString[$i][2], $tabEntrepriseString[$i][3],
		    $tabEntrepriseString[$i][4], $tabEntrepriseString[$i][5],
		    $tabEntrepriseString[$i][6], $tabEntrepriseString[$i][7],
